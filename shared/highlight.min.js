...
/* highlight.js 11.12.0 · core + bash, python, json, javascript, xml, markdown, yaml */
(function(){
var hljs=(function(){/*!
...
},te=ee({});te.newInstance=()=>ee({});;return te;})();
try{hljs.registerLanguage("bash",(function(){/*! `bash` grammar compiled for Highlight.js 11.12.0 */
...
;return hljsGrammar;})());}catch(e){}
try{hljs.registerLanguage("python",(function(){/*! `python` grammar compiled for Highlight.js 11.12.0 */
var hljsGrammar=(()=>{"use strict";return e=>{
const n=e.regex,a=/[\p{XID_Start}_]\p{XID_Continue}*/u,t=["and","as","assert","async","await","break","case","class","continue","def","del","elif","else","except","finally","for","from","global","if","import","in","is","lambda","lazy","match","nonlocal|10","not","or","pass","raise","return","try","while","with","yield"],s={
...
contains:[e.BACKSLASH_ESCAPE,i,l,r]},{begin:/([fFtT][rR]|[rR][fFtT]|[fFtT])"""/,
...
;return hljsGrammar;})());}catch(e){}
try{hljs.registerLanguage("json",(function(){/*! `json` grammar compiled for Highlight.js 11.12.0 */
...
illegal:"\\S"}}})();return hljsGrammar;})());}catch(e){}
try{hljs.registerLanguage("javascript",(function(){/*! `javascript` grammar compiled for Highlight.js 11.12.0 */
...
;return hljsGrammar;})());}catch(e){}
try{hljs.registerLanguage("xml",(function(){/*! `xml` grammar compiled for Highlight.js 11.12.0 */
var hljsGrammar=(()=>{"use strict";return e=>{
...
try{hljs.registerLanguage("markdown",(function(){/*! `markdown` grammar compiled for Highlight.js 11.12.0 */
...
className:"quote",begin:"^>\\s+",contains:l,end:"$"},{className:"code",
variants:[{begin:"(`{3,})[^`](.|\\n)*?\\1`*[ ]*"},{
begin:"(~{3,})[^~](.|\\n)*?\\1~*[ ]*"},{begin:"```",end:"```+[ ]*$"},{
...
;return hljsGrammar;})());}catch(e){}
try{hljs.registerLanguage("yaml",(function(){/*! `yaml` grammar compiled for Highlight.js 11.12.0 */
var hljsGrammar=(()=>{"use strict";return e=>{
...
scope:"char.escape",relevance:0}]},s],b=[...r]
;return b.pop(),b.push(i),l.contains=b,{name:"YAML",case_insensitive:!0,
aliases:["yml"],contains:r}}})();return hljsGrammar;})());}catch(e){}
window.hljs=hljs;
})();
